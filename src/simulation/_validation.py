"""Strict fail-closed validation helpers for the simulation domain.
...
def parse_utc_timestamp(name: str, value: str) -> datetime:
    ...
    Timestamps are declared data, never clock reads: the simulation domain
...
def utc_timestamp_within(
    value: str, valid_from: str, valid_until: str
) -> bool:
