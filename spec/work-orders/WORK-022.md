...
Dependencies: WORK-004 (implementation) + WORK-018 (implementation)

Owned surfaces: `src/data/`.

Forbidden surfaces: no ledger authority; no legal-policy invention.
...
Dogfooding/conformance experiment: exercise a user dispute and a selective-disclosure proof on an isolated dataset.
