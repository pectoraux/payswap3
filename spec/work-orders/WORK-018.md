...
Dependencies: WORK-003 (implementation) + WORK-004 (implementation)

Owned surfaces: `src/evidence/`.

Forbidden surfaces: no second verification authority.
...
Dogfooding/conformance experiment: reconstruct a decision from evidence alone and distinguish observed/predicted/simulated values.
