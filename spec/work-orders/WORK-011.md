...
Assurance: CRITICAL
Dependencies: WORK-005 (implementation) + WORK-006 (implementation) + WORK-009 (implementation)

Owned surfaces: `src/liquidity/`.

Forbidden surfaces: no settlement; no uncontrolled customer funds.
...
Dogfooding/conformance experiment: simulate corridor liquidity/credit bootstrap and exposure limit breach.
