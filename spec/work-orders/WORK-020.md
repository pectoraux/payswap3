...
Assurance: CRITICAL
Dependencies: WORK-003 (implementation) + WORK-009 (implementation) + WORK-017 (implementation) + WORK-018 (implementation)

Owned surfaces: `src/extensions/`.

Forbidden surfaces: no direct ledger/finality/authority mutation.
...
Dogfooding/conformance experiment: install a real extension in simulation, measure contribution, then shadow it.
