...
Assurance: CRITICAL
Dependencies: WORK-007 (implementation) + WORK-014 (implementation) + WORK-016 (implementation) + WORK-023 (implementation) + WORK-027 (implementation)

Owned surfaces: `IG-005`.

Forbidden surfaces: no production credentials required.
