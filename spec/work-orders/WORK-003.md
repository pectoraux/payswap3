...
Forbidden surfaces: no domain-specific authority; no ledger semantics.
...
Dogfooding/conformance experiment: replay identical command traces in a clean process; prove duplicate command convergence.
