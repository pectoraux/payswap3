...
Assurance: CRITICAL
Dependencies: WORK-004 (implementation) + WORK-006 (implementation) + WORK-008 (implementation) + WORK-009 (implementation)

Owned surfaces: `src/safety/`.

Forbidden surfaces: no direct financial mutation.
...
Dogfooding/conformance experiment: exercise approved, stepped-up, held and blocked payment cases with explicit provenance.
