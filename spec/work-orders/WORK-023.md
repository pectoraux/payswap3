...
Assurance: CRITICAL
Dependencies: WORK-003 (implementation) + WORK-004 (implementation) + WORK-016 (implementation)

Owned surfaces: `src/federation/`.

Forbidden surfaces: no unilateral foreign-domain mutation.
