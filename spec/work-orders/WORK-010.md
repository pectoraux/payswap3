...
Dependencies: WORK-006 (implementation) + WORK-008 (implementation) + WORK-009 (implementation)

Owned surfaces: `src/market/`.

Forbidden surfaces: no ledger mutation; no external effect.
...
Dogfooding/conformance experiment: compare RFQ and batch auction on the same demand/offer fixture.
