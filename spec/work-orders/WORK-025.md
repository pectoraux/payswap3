...
Assurance: CRITICAL
Dependencies: WORK-006 (implementation) + WORK-008 (implementation) + WORK-013 (implementation) + WORK-016 (implementation) + WORK-017 (implementation)

Owned surfaces: `src/merchant/`.

Forbidden surfaces: no second payment compiler or settlement authority.
