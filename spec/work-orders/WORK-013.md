...
Dependencies: WORK-006 (implementation) + WORK-008 (implementation) + WORK-009 (implementation) + WORK-010 (implementation) + WORK-011 (implementation) + WORK-012 (implementation) + WORK-017 (implementation)

Owned surfaces: `src/compiler/`.

Forbidden surfaces: no direct external effects or ledger mutation.
...
Dogfooding/conformance experiment: compile a real multi-hop payment twice and verify deterministic semantic equivalence.
