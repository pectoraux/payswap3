...
Assurance: CRITICAL
Dependencies: WORK-019 (implementation) + WORK-026 (implementation) + WORK-027 (implementation)

Owned surfaces: `IG-003`.

Forbidden surfaces: no alternate simulator pipeline.
