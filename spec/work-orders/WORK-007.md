...
Owned surfaces: `src/interoperability/`.

Forbidden surfaces: no live credentials or settlement.
...
Dogfooding/conformance experiment: resolve a test endpoint through canonical and domestic-shaped adapters.
